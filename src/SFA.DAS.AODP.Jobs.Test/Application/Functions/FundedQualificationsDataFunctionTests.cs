...
namespace SFA.DAS.AODP.Jobs.Test.Application.Functions
{
    public class FundedQualificationsDataFunctionTests
    {
        ...
        //    _applicationDbContextMock.Verify(db => db.BulkInsertAsync(It.IsAny<IEnumerable<Qualifications>>()), Times.Never);
        //}
        ...
        //    _applicationDbContextMock.Verify(db => db.BulkInsertAsync(It.IsAny<IEnumerable<FundedQualificationDTO>>()), Times.Never);
        //}
    }
}
