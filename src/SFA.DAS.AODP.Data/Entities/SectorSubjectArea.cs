...
/// <summary>
/// Represents a sector subject area classification, including its code and descriptive name.
/// </summary>
/// <remarks>This record provides predefined instances for a wide range of sector subject areas, enabling
/// consistent categorization across applications. Use the static properties to reference specific areas, or the
/// provided methods to look up an area by code or name. Sector subject area codes follow a tiered format (e.g., "1.1"
/// for Medicine and Dentistry).</remarks>
