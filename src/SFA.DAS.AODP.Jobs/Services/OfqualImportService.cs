...
namespace SFA.DAS.AODP.Jobs.Services
{
    public class OfqualImportService : IOfqualImportService
    {
        ...
        //                var organisationId = Convert.ToInt32(qualificationData.AwardingOrganisationId.Value);
        //                if (!existingOrganisations.TryGetValue(organisationId, out var organisation))
        //                {
